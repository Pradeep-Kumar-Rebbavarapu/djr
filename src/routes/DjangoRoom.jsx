...
export default function DjangoRoom() {
    ...
    const client = new W3CWebSocket('ws://127.0.0.1:8000/ws/chat/' + roomID + '/')
    var localstream;
        ...
        client.onmessage = (message) => {
            ...
            if (event == "user-connected") {
                ...
                if (screenShareRef.current) {
                    ...
                    connectToNewUser(userID, localstream, "video");
                }
            }
        ...
        navigator.mediaDevices
            ...
            .then((stream) => {
                ...
                peer.on("call", (call) => {
                    ...
                    if (type === "screen" && screenShareRef.current) {
                        call.answer(screenShareRef.current);
                    } else {
                        call.answer(stream);
                    }
